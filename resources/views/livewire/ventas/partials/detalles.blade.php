                            ...
                            <table class="table table-bordered table-striped mt-1">
                                <thead class="text-white table-dark" style="background: #3B3F5C">
                                    <tr>
                                        ...
                                        <th width="45%" class="table-th text-left text-white">DESCRIPCIÓN</th>
                                        <th width="10%" class="table-th text-center text-white">CANTIDAD</th>
                                        <th width="15%" class="table-th text-center text-white">PRECIO</th>
                                        <th width="15%"class="table-th text-center text-white">Sub Total</th>
                                        <th width="10%" class="table-th text-center text-white">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>

                        ...
                        <table class="table table-bordered table-striped mt-1">
                            <thead class="text-white" style="background: #3B3F5C">
                                <tr>
                                    ...
                                    <th width="30%" class="table-th text-left text-white">DESCRIPCIÓN</th>
                                    <th width="10%" class="table-th text-center text-white">COSTO Bs.</th>
                                    <th width="10%" class="table-th text-center text-white">CANT</th>
                                    <th width="10%" class="table-th text-center text-white">SUB TOTAL</th>
                                    <th width="15%" class="table-th text-center text-white">ACCIONES</th>
                                </tr>
                            </thead>
                            <tbody>

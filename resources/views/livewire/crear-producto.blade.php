                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('marca') is-invalid @enderror" id="marca"
                                            wire:model="marca">
                                            <option value="">-- Seleccione --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('origen') is-invalid @enderror"
                                            id="origen" wire:model="origen">
                                            <option value="">-- Seleccione --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="stock_minimo" wire:model="stock_minimo"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="unidad_medida" wire:model="unidad_medida"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control @error('cantidad_unidad') is-invalid @enderror"

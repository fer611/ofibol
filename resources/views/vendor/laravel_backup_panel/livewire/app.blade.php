@guest
    <div class="container text-center mt-5">
        <h5 class="text-danger">¡Acceso no autorizado! Por favor, inicia sesión para acceder al panel de backup.</h5>
    </div>
@else
    @auth
        @can('usuarios.create')
        ...
        <div class="container text-center mt-5">
            <h5 class="text-danger">¡No tienes permisos para acceder al panel de backup!</h5>
        </div>
        @endcan
    @endauth
@endguest
